...
- happy-path producer/consumer flow from `.codex/skills/delivery-prepare/scripts/build_delivery_contract.py`
  into `.codex/skills/delivery-closeout/scripts/read_delivery_contract.py`
