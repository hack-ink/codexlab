...
- a raw-JSON `plan/1` contract produced for `plan-writing` is directly consumable by the
...
- non-JSON saved plans, missing blocker reasons, and `done` states with unfinished tasks all
