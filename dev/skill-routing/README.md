...
- Keep [`.codex/skills/skill-routing/child-skill-policy.toml`](../../.codex/skills/skill-routing/child-skill-policy.toml) minimal and distribution-safe.
- Keep [`.codex/skills/skill-routing/routing-fixtures.json`](../../.codex/skills/skill-routing/routing-fixtures.json) as the canonical prompt-fixture contract for overlay routing examples.
- Keep the primary workflow reference list in [`.codex/skills/skill-routing/SKILL.md`](../../.codex/skills/skill-routing/SKILL.md) authoritative for fixture `expect_primary_process_skills` names.
...
- Overlay fixture expectations must reference known local overlay skills, and primary workflow expectations must reference the checked-in `.codex/skills/skill-routing/SKILL.md` list rather than the repo-local installable-skill catalog.
...
2. Canonicalize the template when needed:
  - `python3 .codex/skills/skill-routing/scripts/build_child_skill_policy.py --write`
